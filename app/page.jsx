      ...
      <section className="py-12">
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {/* Featured Cars List */}
            {/* Map through featured cars and display them */}
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-6">
            {carMakes.map((make) => {
              return (
                ...
                >
                  <div className="relative h-16 w-full mx-auto mb-2">
                    <Image
                      src={make.image}
                      alt={make.name}
                      fill
            ...
            {bodyTypes.map((type) => {
              return (
                <Link
                  ...
                  className="relative curosr-pointer group"
                >
                  <div className="justify-end overflow-hidden rounded-lg flex h-28 mb-4 relative">
                    <Image
                      src={type.image}
                      alt={type.name}
                      fill
                      className="transition object-cover group-hover:scale-105 duration-300"
                    />
                  </div>
                  <div className="absolute inset-0 bg-gradient-to-t from-black/70 to-transparent rounded-lg flex items-end">
                    <h3 className="text-white font-bold pl-4 pb-2 text-xl">{type.name}</h3>
                  </div>
                </Link>
              );
            })}
